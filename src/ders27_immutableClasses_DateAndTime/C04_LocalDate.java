...
public class C04_LocalDate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tarih.minusWeeks(5).minusDays(3)); // 5 hafta 3 gun once
        ...
        System.out.println(tarih.withYear(1987).withMonth(2).withDayOfMonth(15).getDayOfWeek()); // SUNDAY
