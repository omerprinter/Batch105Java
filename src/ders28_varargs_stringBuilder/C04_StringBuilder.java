...
public class C04_StringBuilder {
    public static void main(String[] args) {
        ...
        // Bu kod yazilldiginda java 7 karakter alabilecek bir StringBuilder olusturur
        System.out.println(sb.capacity()); //  7
        System.out.println(sb.length());  // 0  hicbir deger atanmadigi icin
        ...
        System.out.println(sb.capacity()); //  16  (7*2+2)
